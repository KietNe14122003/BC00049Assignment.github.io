...
class getCategoryControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.AGIUpEn'] ?? $container->load('get_ServiceLocator_AGIUpEnService'))->withContext('App\\Controller\\CategoryController', $container));
