...
class __TwigTemplate_5d92ea6682ed4229fdd61577bef2d045 extends Template
{
    private $source;
    private $macros = [];
...
<link rel=\"stylesheet\" href=\"";
        // line 69
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("cssK/Stafflist.css"), "html", null, true);
        echo "\"/>
";
    ...
    {
        return array (  236 => 69,  232 => 68,  227 => 67,  217 => 66,  200 => 58,  190 => 57,  175 => 51,  156 => 46,  152 => 45,  147 => 43,  143 => 42,  139 => 41,  135 => 40,  131 => 39,  128 => 38,  111 => 37,  94 => 22,  90 => 19,  80 => 6,  61 => 4,  38 => 2,);
    }
         ...
         <tbody>
            {% for staff in data %}
                <tr>
                    ...
                    <td>
                        <a href=\"{{path('app_edit_staff',{'id':staff.getId()})}}\" class=\"btn btn-outline-dark\"> Edit</a>
                        <a href=\"javascript:deletestaff('{{path('app_delete_staff',{'id':staff.getId()})}}')\" class=\"btn btn-outline-dark\"> Delete</a>
