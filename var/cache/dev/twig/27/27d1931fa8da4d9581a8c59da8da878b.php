...
class __TwigTemplate_665246d39d054b8461905495a8de881d extends Template
{
    private $source;
    private $macros = [];
...
<html>
   ...
   <body>
      ";
        // line 33
        $this->loadTemplate("header.html.twig", "contact/Customer/contact.html.twig", 33)->display($context);
        // line 34
        echo "
      <!-- header section end -->
      ...
      <div class=\"contact_section layout_padding\" style=\"background-color: white;\">
        ...
        echo "
                        ";
        // line 53
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 53, $this->source); })()), "Name", [], "any", false, false, false, 53), 'widget', ["attr" => ["class" => "mail_text", "placeholder" => "Your Name"]]);
        echo "
                        ";
        // line 54
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 54, $this->source); })()), "Email", [], "any", false, false, false, 54), 'widget', ["attr" => ["class" => "mail_text", "placeholder" => "Your Email"]]);
        echo "
                        ";
        // line 55
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 55, $this->source); })()), "Phone", [], "any", false, false, false, 55), 'widget', ["attr" => ["class" => "mail_text", "placeholder" => "Your Phone"]]);
        echo "
                        ";
        // line 56
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 56, $this->source); })()), "Message", [], "any", false, false, false, 56), 'widget', ["attr" => ["class" => "mail_text", "placeholder" => "Message"]]);
        echo "     
      ...
      ";
        // line 76
        $this->loadTemplate("footer.html.twig", "contact/Customer/contact.html.twig", 76)->display($context);
        // line 77
        echo "
    ...
    {
        return array (  147 => 77,  145 => 76,  127 => 61,  119 => 56,  115 => 55,  111 => 54,  107 => 53,  103 => 52,  83 => 34,  81 => 33,  65 => 20,  45 => 2,  43 => 1,);
    }
